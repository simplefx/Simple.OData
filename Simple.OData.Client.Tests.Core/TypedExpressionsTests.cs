...
namespace Simple.OData.Client.Tests
{
    public class TypedExpressionTests
    {
        ...
        public void And()
        {
            ...
            Assert.Equal("ProductID eq 1 and ProductName eq 'Chai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void Or()
        {
            ...
            Assert.Equal("ProductName eq 'Chai' or ProductID eq 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void Not()
        {
            ...
            Assert.Equal("not(ProductName eq 'Chai')", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void Precedence()
        {
            ...
            Assert.Equal("(ProductID eq 1 or ProductID eq 2) and ProductName eq 'Chai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductName == "Chai";
            Assert.Equal("ProductName eq 'Chai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualNumeric()
        {
            ...
            Assert.Equal("ProductID eq 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID != 1;
            Assert.Equal("ProductID ne 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID > 1;
            Assert.Equal("ProductID gt 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void GreaterOrEqualNumeric()
        {
            ...
            Assert.Equal("ProductID ge 1.5", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID < 1;
            Assert.Equal("ProductID lt 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID <= 1;
            Assert.Equal("ProductID le 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void AddEqualNumeric()
        {
            ...
            Assert.Equal("ProductID add 1 eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID - 1 == 2;
            Assert.Equal("ProductID sub 1 eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID * 1 == 2;
            Assert.Equal("ProductID mul 1 eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID / 1 == 2;
            Assert.Equal("ProductID div 1 eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        {
            Expression<Func<TestEntity, bool>> filter = x => x.ProductID % 1 == 2;
            Assert.Equal("ProductID mod 1 eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualLong()
        {
            ...
            Assert.Equal("ProductID eq 1L", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualDecimal()
        {
            ...
            Assert.Equal("Price eq 1.00M", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualDecimalWithFractionalPart()
        {
            ...
            Assert.Equal("Price eq 1.23M", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualGuid()
        {
            ...
            Assert.Equal("LinkID eq guid'00000000-0000-0000-0000-000000000000'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualDateTime()
        {
            ...
            Assert.Equal("CreationTime eq datetime'2013-01-01T00:00:00.0000000Z'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void EqualTimeSpan()
        {
            ...
            Assert.Equal("Period eq time'01:02:03'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void LengthOfStringEqual()
        {
            ...
            Assert.Equal("length(ProductName) eq 4", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void StringToLowerEqual()
        {
            ...
            Assert.Equal("tolower(ProductName) eq 'chai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void StringToUpperEqual()
        {
            ...
            Assert.Equal("toupper(ProductName) eq 'CHAI'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void StringStartsWithEqual()
        {
            ...
            Assert.Equal("startswith(ProductName,'Ch') eq true", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void StringEndsWithEqual()
        {
            ...
            Assert.Equal("endswith(ProductName,'Ch') eq true", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void IndexOfStringEqual()
        {
            ...
            Assert.Equal("indexof(ProductName,'ai') eq 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void SubstringWithPositionEqual()
        {
            ...
            Assert.Equal("substring(ProductName,1) eq 'hai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void SubstringWithPositionAndLengthEqual()
        {
            ...
            Assert.Equal("substring(ProductName,1,2) eq 'ha'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void ReplaceStringEqual()
        {
            ...
            Assert.Equal("replace(ProductName,'a','o') eq 'Choi'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void TrimEqual()
        {
            ...
            Assert.Equal("trim(ProductName) eq 'Chai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void ConcatEqual()
        {
            ...
            Assert.Equal("concat(ProductName,'Chai') eq 'ChaiChai'", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void DayEqual()
        {
            ...
            Assert.Equal("day(CreationTime) eq 1", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void MonthEqual()
        {
            ...
            Assert.Equal("month(CreationTime) eq 2", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void YearEqual()
        {
            ...
            Assert.Equal("year(CreationTime) eq 3", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void HourEqual()
        {
            ...
            Assert.Equal("hour(CreationTime) eq 4", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void MinuteEqual()
        {
            ...
            Assert.Equal("minute(CreationTime) eq 5", ODataExpression.FromLinqExpression(filter).ToString());
        }
        ...
        public void SecondEqual()
        {
            ...
            Assert.Equal("second(CreationTime) eq 6", ODataExpression.FromLinqExpression(filter).ToString());
        }
